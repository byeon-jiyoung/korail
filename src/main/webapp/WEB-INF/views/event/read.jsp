			...
			<div id="notice_list">
				...
				<table>
					<tr>
						...
						<td colspan="5" class="titleleft">${event.eTitle}</td>
					</tr>
					<tr>
						...
						<td>${event.eReadcnt}</td>
					</tr>
					<tr>
						<td colspan="6" class="no_content">
							${event.eContent}
							<c:if test="${event.eImg != null}">
								<img src="displayFile?filename=${event.eImg}" class="no_img">
							</c:if>
						</td>
					</tr>
				</table>
				<a href="${pageContext.request.contextPath}/event/event?page=${cri.page}"><button id="goNoticeList">목록</button></a>
			</div>
			<div id="notice_etc">
